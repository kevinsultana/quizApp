export default [
  ...
  {
    id: "q8",
    text: "Which attribute should be provided to list items in React to improve performance?",
    answers: [
      "A unique 'key' prop.",
      "An id attribute.",
      "A value attribute.",
  ...
  {
    id: "q9",
    text: "What happens when you update the state in a React component?",
    answers: [
      "The component re-renders with the new state.",
      "The page reloads to reflect the change.",
      "The application state resets.",
      "The props are updated too.",
    ],
  },
  {
    id: "q10",
    text: "How does lifting state up help in React?",
    answers: [
      "It allows shared state between multiple components.",
      "It pushes state updates to the server.",
      "It sends state data to Redux for storage.",
